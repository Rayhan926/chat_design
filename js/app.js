...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  {
    "../../../../../Users/FC/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js": [
  ...
  \**************************************************/
    ...
    "functions.js": [
      function (require, module, exports) {
        ...
        var dropdown_autoset = function dropdown_autoset(
          e,
          downClass,
          upClass
        ) {
          ...
          var spaceUp =
            ...
            (0, _jquery.default)(document).scrollTop();
          var spaceDown =
            (0, _jquery.default)(document).scrollTop() +
        ...
        var outside_close = function outside_close(
          click_on,
          close_to,
          close_class,
          e
        ...
        var set_ripple = function set_ripple(e) {
          ...
          var x =
            e.pageX -
            (0, _jquery.default)(e.currentTarget).offset().left +
            "px";
          var y =
            e.pageY - (0, _jquery.default)(e.currentTarget).offset().top + "px";
          var width = (0, _jquery.default)(e.currentTarget).width() * 4 + "px";
          var randClass = "ripple_" + Math.floor(Math.random() * 9999999);
          var rippleSpan = '<span class="ripple_span '
            .concat(randClass, '" style="left: ')
            .concat(x, "; top: ")
            .concat(y, "; background:")
            .concat(cstmBg, '"></span>');
          var timeIs = 500;
        ...
        var set_Active_Tab_Bottom_Bar_Posotion = function set_Active_Tab_Bottom_Bar_Posotion(
          ...
          var thisTabFromLeft = document
            .querySelector(".swiper-pagination-bullet-active")
            .getBoundingClientRect();
          var paginationWrapFromLeft = document
            .querySelector(".swiper-pagination")
            .getBoundingClientRect();
          var result =
            thisTabFromLeft.left - paginationWrapFromLeft.left + "px";
        ...
        var tab_1_hash = function tab_1_hash() {
          get_hash("chats")
            ? (0, _jquery.default)("#tab_no_0").trigger("click")
            : null;
        };
        ...
        var tab_2_hash = function tab_2_hash() {
          get_hash("requests")
            ? (0, _jquery.default)("#tab_no_1").trigger("click")
            : null;
        };
        ...
        var tab_3_hash = function tab_3_hash() {
          get_hash("sendRequests")
            ? (0, _jquery.default)("#tab_no_2").trigger("click")
            : null;
        };
        ...
        var change_placeholder = function change_placeholder(val) {
          (0, _jquery.default)(".header_search_wrap input").attr(
            "placeholder",
            val
          );
        };
        ...
        var profile_image_view_mode = function profile_image_view_mode(e) {
          ...
          if (!(0, _jquery.default)(thisElm).hasClass("view_photo_mode")) {
            ...
            var compo = '<section class="profile_img_view_mode_section">\n                  <div class="img_container" style="left: '
              .concat(currentLeft, "; top: ")
              .concat(currentTop, "; width: ")
              .concat(currentWidth, "; height: ")
              .concat(currentHeight, ' ">\n                    <img src="')
              .concat(
                imgSrc,
                '" alt="Image" />\n                  </div>\n                </section>'
              );
            ...
            setTimeout(function () {
              (0, _jquery.default)(
                ".profile_img_view_mode_section .img_container"
              ).css({
                width: widthBig + "px",
                height: widthBig + "px",
                borderRadius: "0px",
        ...
        var hide_profile_image_view_mode = function hide_profile_image_view_mode(
          e
        ) {
          if (
            (0, _jquery.default)(e.target).hasClass(
        ...
        var profile_image_view_in_full_screen_mode = function profile_image_view_in_full_screen_mode(
          e
        ) {
          // prevFullScreenImgSrcElm = e;
          var imgSrc = (0, _jquery.default)(e.currentTarget)
            .find("img")
            .attr("src");
        ...
        var toggle_login_signup_section = function toggle_login_signup_section(
          e
        ) {
          e.preventDefault();
        ...
        var change_placeholder_all = function change_placeholder_all() {
          var activeTabBullet = (0, _jquery.default)(
            ".swiper-pagination-bullet-active"
          ).attr("id");
          activeTabBullet == "tab_no_0" ? change_placeholder("Search..") : null;
          activeTabBullet == "tab_no_1"
            ? change_placeholder("Search request")
            : null;
        ...
        var on_chat_select_mode = function on_chat_select_mode(e) {
          if (!isSelectionStart) {
            ...
            (0, _jquery.default)(".chat_wrapper").addClass(
              "chat_selected_mode_on"
            );
        ...
        var off_chat_select_mode = function off_chat_select_mode() {
          ...
          (0, _jquery.default)(".chat_wrapper").removeClass(
            "chat_selected_mode_on"
          );
        ...
        var select_more_then_one_message = function select_more_then_one_message(
          e
        ) {
            ...
            if (message_select_mode_on) {
              if (!(0, _jquery.default)(thisElm).hasClass("messageSelected")) {
                ...
                if (!messageFirstSelect) {
                  (0, _jquery.default)(thisElm).removeClass("messageSelected");
                  messageSelectedCount--;
                }
              }
            }
        ...
        var on_message_select_mode = function on_message_select_mode(e) {
          if (!isMessageSelectionStart) {
            ...
            (0, _jquery.default)(e.currentTarget)
              .parent()
              .addClass("messageSelected");
    ...
    "app.js": [
      function (require, module, exports) {
        ...
        var swiper = new Swiper(".swiper-container", {
          ...
          paginationBulletRender: function paginationBulletRender(
            ...
            if (index === tabsName.length - 1) {
              return (
                '<span class="'
                  .concat(className, '" id="tab_no_')
                  .concat(index, '">')
                  .concat(tabsName[index], "</span>") +
                '<div class="active_tab_bottom_bar"></div>'
              );
            }
        ...
        swiper.on("transitionEnd", function () {
          ...
          if (
            (0, _jquery.default)(".swiper-pagination-bullet-active").attr(
              "id"
            ) == "tab_no_0"
          )
          ...
          if (
            ...
            (0, _functions.set_hash)("requests");
          if (
            (0, _jquery.default)(".swiper-pagination-bullet-active").attr(
              "id"
            ) == "tab_no_2"
          )
            (0, _functions.set_hash)("sendRequests");
        }); // $.event.special.tap.tapholdThreshold = 300;

        var hash_with_url =
          (0, _functions.get_hash)() == ""
            ? "chats"
            : (0, _functions.get_hash)();
        var startFrom,
          totalSwiped,
        ...
        (0, _jquery.default)(document).on("touchmove", swipeElm, function (e) {
          if (!_functions.isMessageSelectionStart) {
            if (e.targetTouches.length == 1) {
              messageSwiping = true;
              var thisFrowardIcon = (0, _jquery.default)(e.currentTarget)
                .parent()
              ...
              var forwardIconLeft = fromLeft - 30 > 15 ? 15 : fromLeft - 30;
        ...
        (0, _jquery.default)(document).on("touchend", swipeElm, function (e) {
          ...
          var thisFrowardIcon = (0, _jquery.default)(elm)
            .parent()
            .find(".forward_activate_icon_box");
        ...
        (0, _jquery.default)(document).on("long-press", swipeElm, function (e) {
          if (!_functions.isMessageSelectionStart && !messageSwiping)
            (0, _functions.on_message_select_mode)(e);
        });
        ...
        (0, _jquery.default)(document).on(
          ...
          "".concat(parentDiv, " input"),
          function (e) {
            var thisVal = _jquery.default.trim(
              (0, _jquery.default)(e.currentTarget).val()
            );

            var parent = (0, _jquery.default)(e.currentTarget).parents(
              parentDiv
            );
        ...
        (0, _jquery.default)(".chat_image_box").on("click", function (e) {
          !_functions.chat_select_mode_on
            ? (0, _functions.profile_image_view_mode)(e)
            : null; // profile_image_view_mode(e);
        ...
        (0, _jquery.default)(".header_search_icon_wrap").on(
          "click",
          function () {
        ...
        (0, _jquery.default)(document).on(
          ...
          ".chating_image_box",
          function (e) {
            !_functions.message_select_mode_on
              ? (0, _functions.profile_image_view_in_full_screen_mode)(e)
              : null;
          }
        ...
        (0, _jquery.default)(".chat_click_ripple_wrap").on(
          "click",
          function () {
            !_functions.chat_select_mode_on
        ...
        (0, _jquery.default)(document).on(
          ...
          _functions.clickElm,
          function (e) {
            if (!_functions.isSelectionStart)
              (0, _functions.on_chat_select_mode)(e);
          }
        );
        (0, _jquery.default)(document).on(
          "click",
        ...
        (0, _jquery.default)(document).on(
          "click",
          ".chating_header_wrap .back_button_box",
          function () {
        ...
        (0, _jquery.default)(".go_to_next_step_box button").click(function () {
          (0, _jquery.default)(".signup_step_wrapper").toggleClass(
            "active_step_two"
          );
        });
    ...
    "../../../../../Users/FC/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js": [
      function (require, module, exports) {
        var global = arguments[3];
