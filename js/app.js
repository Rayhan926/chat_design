...
(0, _jquery.default)(document).on("touchmove", swipeElm, function (e) {
  if (e.targetTouches.length == 1) {
    ...
    fromLeft >= 40 ? thisFrowardIcon.addClass("forwardActivated") : thisFrowardIcon.removeClass("forwardActivated");
    var forwardIconLeft = fromLeft - 30 > 5 ? 5 : fromLeft - 30;
...
(0, _jquery.default)(document).on("long-press", swipeElm, function (e) {
  // on_message_select_mode
  if (!_functions.isMessageSelectionStart) (0, _functions.on_message_select_mode)(e);
...
(0, _jquery.default)(document).on("touchend", swipeElm, function (e) {
  ...
  if (totalSwiped >= 40) {// alert("adadad");
  }
...
(0, _jquery.default)(document).on("swiperight", swipeElm, function (e) {
  console.log(e);
}); // search_bar_hash();
// chating_hash();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7759" + '/');
