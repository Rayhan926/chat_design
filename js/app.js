...
var dropdown_autoset = function dropdown_autoset(e, downClass, upClass) {
  ...
  var current_target = (0, _jquery.default)(e.currentTarget);
  var dropdown_menu = current_target.find("[data-dropdown-ul]");
  var dorpdown_wrap_offsetTop = current_target.parent().offset().top;
  var this_height = current_target.height();
  var spaceUp = dorpdown_wrap_offsetTop - this_height - dropdown_menu.height() - (0, _jquery.default)(document).scrollTop();
  var spaceDown = (0, _jquery.default)(document).scrollTop() + document.documentElement.clientHeight - (dorpdown_wrap_offsetTop + dropdown_menu.height());
...
var set_ripple = function set_ripple(e) {
  ...
  if (cstmBg) {
    cstmBg = (0, _jquery.default)(e.currentTarget).data("ripple-bg");
  } else {
    cstmBg = "rgba(255, 255, 255, 0.1)";
  }

  var x = e.pageX - (0, _jquery.default)(e.currentTarget).offset().left + "px";
  var y = e.pageY - (0, _jquery.default)(e.currentTarget).offset().top + "px";
  var width = (0, _jquery.default)(e.currentTarget).width() * 4 + "px";
  var randClass = "ripple_" + Math.floor(Math.random() * 9999999);
  var rippleSpan = "<span class=\"ripple_span ".concat(randClass, "\" style=\"left: ").concat(x, "; top: ").concat(y, "; background:").concat(cstmBg, "\"></span>");
  var timeIs = 500;
  (0, _jquery.default)(e.currentTarget).append(rippleSpan);
  (0, _jquery.default)(".ripple_span").animate({
    width: width,
    height: width
  }, timeIs, function () {
    setTimeout(function () {
      (0, _jquery.default)("." + randClass).fadeOut(100);
      setTimeout(function () {
        (0, _jquery.default)("." + randClass).remove();
      }, 100);
    }, 20);
  });
};
...
var show_seacrh_input = function show_seacrh_input() {
  ...
  (0, _jquery.default)(".search_friends_wrap").slideUp(200);
};

exports.show_seacrh_input = show_seacrh_input;

var hide_seacrh_input = function hide_seacrh_input() {
  (0, _jquery.default)(".header_search_wrap").removeClass("show");
  (0, _jquery.default)(".header_search_wrap input").val("");
  (0, _jquery.default)(".swiper-pagination").removeClass("hide");
  (0, _jquery.default)(".search_friends_wrap").slideDown(200);
};

exports.hide_seacrh_input = hide_seacrh_input;

var change_placeholder = function change_placeholder(val) {
  (0, _jquery.default)(".header_search_wrap input").attr("placeholder", val);
};
...
var currentWidthFullScreen, currentHeightFullScreen, currentTopFullScreen, currentLeftFullScreen;
...
var profile_image_view_in_full_screen_mode = function profile_image_view_in_full_screen_mode(e) {
  ...
  currentTopFullScreen = thisElm.offset().top - (0, _jquery.default)(".chat_wrapper").offset().top;
  currentLeftFullScreen = thisElm.offset().left - (0, _jquery.default)(".chat_wrapper").offset().left; // let bigImgFromTop = $(".chat_wrapper").height() / 2 - 152 + "px";

  var imgSrc = (0, _jquery.default)(e.currentTarget).find("img").attr("src");
  var compo = "<div class=\"bg_black_full\">\n  <div class=\"bg_black_btn_wrap\">\n    <button data-ripple>\n    <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-arrow-left\"><line x1=\"19\" y1=\"12\" x2=\"5\" y2=\"12\"></line><polyline points=\"12 19 5 12 12 5\"></polyline></svg>\n    </button>\n  </div>\n  <div class=\"img_hide_box\"><img src=\"".concat(imgSrc, "\" alt=\"Me\" /></div>\n  <div class=\"img_full_screen_box\" style=\"width:").concat(currentWidthFullScreen, "px; left:").concat(currentLeftFullScreen, "px; top:").concat(currentTopFullScreen, "px\">\n  <img src=\"").concat(imgSrc, "\" alt=\"Me\" />\n  </div>\n</div>");
  (0, _jquery.default)(".chat_wrapper").append(compo);
  var fromTopPosition = (0, _jquery.default)(".chat_wrapper").height() / 2 - (0, _jquery.default)(".img_hide_box").height() / 2 + "px"; // anime({
  ...
  (0, _jquery.default)(".bg_black_full .img_full_screen_box").animate({
    width: "100%",
    left: "0",
    top: fromTopPosition
  }, 500);
...
var toggle_login_signup_section = function toggle_login_signup_section(e) {
  e.preventDefault();
  (0, _jquery.default)(".login_wrap").slideToggle(300);
  (0, _jquery.default)(".signup_wrap").slideToggle(300);
};

exports.toggle_login_signup_section = toggle_login_signup_section;

var change_placeholder_all = function change_placeholder_all() {
  var activeTabBullet = (0, _jquery.default)(".swiper-pagination-bullet-active").attr("id");
  activeTabBullet == "tab_no_0" ? change_placeholder("Search..") : null;
  activeTabBullet == "tab_no_1" ? change_placeholder("Search request") : null;
  activeTabBullet == "tab_no_2" ? change_placeholder("Find friends by username") : null;
};
...
var chating_hash = function chating_hash() {
  ...
  //   close_chating_section();
  // }
  if (!get_hash("ImgInFullScreen") && !get_hash("chating") && !get_hash("messageSelected")) {
    close_chating_section();
  }
};
...
exports.clickElm = clickElm;
var chat_select_mode_on = false;
exports.chat_select_mode_on = chat_select_mode_on;
var selectedCount = 0,
    firstSelect = false;
var isSelectionStart = false;
exports.isSelectionStart = isSelectionStart;
...
exports.select_more_then_one_chat = select_more_then_one_chat;

var on_chat_select_mode = function on_chat_select_mode(e) {
  if (!isSelectionStart) {
    set_hash("chatSelected");
    exports.chat_select_mode_on = chat_select_mode_on = true;
...
exports.on_chat_select_mode = on_chat_select_mode;

var off_chat_select_mode = function off_chat_select_mode() {
  exports.chat_select_mode_on = chat_select_mode_on = false;
...
var isMessageSelectionStart = false;
exports.isMessageSelectionStart = isMessageSelectionStart;

var select_more_then_one_message = function select_more_then_one_message(e) {
  if (isMessageSelectionStart) {
    var thisElm = (0, _jquery.default)(e.currentTarget).parent();

    if (message_select_mode_on) {
      if (!(0, _jquery.default)(thisElm).hasClass("messageSelected")) {
        (0, _jquery.default)(thisElm).addClass("messageSelected");
        messageSelectedCount++;
      } else {
        if (!messageFirstSelect) {
          (0, _jquery.default)(thisElm).removeClass("messageSelected").css({
            pointerEvents: "none"
          });
          setTimeout(function () {
            (0, _jquery.default)(thisElm).css({
              pointerEvents: "all"
            });
          }, 500);
          messageSelectedCount--;
...
exports.select_more_then_one_message = select_more_then_one_message;

var on_message_select_mode = function on_message_select_mode(e) {
  if (!isMessageSelectionStart) {
    set_hash("messageSelected");
    exports.message_select_mode_on = message_select_mode_on = true;
    (0, _jquery.default)(e.currentTarget).parent().addClass("messageSelected");
...
exports.on_message_select_mode = on_message_select_mode;

var off_message_select_mode = function off_message_select_mode() {
  exports.message_select_mode_on = message_select_mode_on = false;
  (0, _jquery.default)(".chat_wrap").removeClass("messageSelected");
  messageFirstSelect = false;
...
var open_user_profile_section = function open_user_profile_section(elm) {
  var parentWrapOffset = (0, _jquery.default)(".chat_wrapper").offset();
  var fromTop = elm.offset().top - parentWrapOffset.top + "px";
  var fromLeft = elm.offset().left - parentWrapOffset.left + "px";
  var imgSrc = elm.find("img").attr("src");
  var compo = "<div class=\"user_profile_view_section_wrap\">\n    <div class=\"back_to_user_profile_button_box\">\n      <i data-feather=\"arrow-left\"></i>\n    </div>\n    <div class=\"user_profile_picture_wrap\">\n      <div class=\"profile_pic_img_box\">\n        <img src=\"".concat(imgSrc, "\" alt=\"\" />\n      </div>\n      <div class=\"user_name_box\">\n        <h2>Rayhan Ahmed</h2>\n      </div>\n    </div>\n    <div class=\"user_profile_details_wrap\"></div>\n  </div>");
  (0, _jquery.default)(".chat_wrapper").append(compo);

  _featherIcons.default.replace();

  (0, _jquery.default)(".profile_pic_img_box").css({
    transform: "translateX(".concat(fromLeft, ") translateY(").concat(fromTop, ")"),
    opacity: "1"
  });
  setTimeout(function () {
    (0, _jquery.default)(".user_profile_view_section_wrap").addClass("show");
    (0, _animejs.default)({
...
exports.open_user_profile_section = open_user_profile_section;

var close_user_profile_section = function close_user_profile_section() {
  (0, _jquery.default)(".user_profile_view_section_wrap").addClass("slideToHide");
  setTimeout(function () {
    (0, _jquery.default)(".user_profile_view_section_wrap").remove();
  }, 250);
};

exports.close_user_profile_section = close_user_profile_section;
...
exports.a = a;
},{"jquery":"../../node_modules/jquery/dist/jquery.js","animejs":"../../node_modules/animejs/lib/anime.es.js","feather-icons":"../../node_modules/feather-icons/dist/feather.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).on("mousemove", swipeElm, function (e) {
  if (_functions.obj.swipeWithMouse && !(0, _jquery.default)(e.currentTarget).parent().hasClass("messageSelected")) {
    var thisElm = (0, _jquery.default)(e.currentTarget);
...
// }
// console.log(validURL("fas saf saf facebook.com"));
...
(0, _jquery.default)(document).on("blur", "".concat(parentDiv, " input"), function (e) {
  var thisVal = _jquery.default.trim((0, _jquery.default)(e.currentTarget).val());
...
// Show And Hide All Dropdwn ----Start----
...
(0, _jquery.default)(document).on("click", function (e) {
  (0, _functions.outside_close)(wrap, wrap, "showDown showUp", e);
}); // Show And Hide All Dropdwn ----End----
// Set Ripple ----Start----

(0, _jquery.default)(document).on("click", "[data-ripple]", function (e) {
  (0, _functions.set_ripple)(e);
}); // Set Ripple ----End----

(0, _jquery.default)(document).on("click", ".chat_personn_name_box .img_box", function (e) {
  (0, _functions.open_user_profile_section)((0, _jquery.default)(e.currentTarget));
});
(0, _jquery.default)(document).on("click", ".back_to_user_profile_button_box", function () {
  (0, _functions.close_user_profile_section)();
});
(0, _jquery.default)(document).on("click", ".chat_personn_name_box", function (e) {
  var childrenElm = (0, _jquery.default)(e.currentTarget).find(".img_box");
  (0, _functions.open_user_profile_section)(childrenElm);
});
(0, _jquery.default)(document).on("click", ".user_profile_picture_wrap .profile_pic_img_box", function (e) {
  (0, _functions.profile_image_view_in_full_screen_mode)(e);
}); // Tab Pagination Bottom Line Position Set ----Start----

(0, _jquery.default)(document).on("click", ".swiper-pagination-bullet", function () {
  (0, _functions.set_Active_Tab_Bottom_Bar_Posotion)();
}); // Tab Pagination Bottom Line Position Set ----End----
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14741" + '/');
