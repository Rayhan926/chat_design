  ...
  var a,
    ...
    function u(e) {
      ...
      var a = w.mousewheel.event,
          t = 0;
      if (e.detail) t = -e.detail;else if ("mousewheel" === a) {
      ...
      } else if ("DOMMouseScroll" === a) t = -e.detail;else if ("wheel" === a) if (w.params.mousewheelForceToAxis) {
        if (i()) {
      ...
      if (w.params.mousewheelInvert && (t = -t), w.params.freeMode) {
        ...
        if (new window.Date().getTime() - w.mousewheel.lastScrollTime > 60) if (0 > t) {
    ...
    for (var g in f) {
      if ("undefined" == typeof s[g]) s[g] = f[g];else if ("object" == _typeof(s[g])) for (var v in f[g]) {
    ...
    if (w.version = "3.1.0", w.params = s, w.classNames = [], "undefined" != typeof a && "undefined" != typeof r && (a = r), ("undefined" != typeof a || (a = "undefined" == typeof r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (w.$ = a, w.container = a(e), 0 !== w.container.length)) {
      ...
      window.navigator.pointerEnabled ? y = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (y = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), w.touchEvents = {
        ...
        var t = l(e, "." + w.params.slideClass),
            r = !1;
        if (t) for (var s = 0; s < w.slides.length; s++) {
          w.slides[s] === t && (r = !0);
        }
      ...
      if (w.onTouchStart = function (e) {
        ...
        if (w.params.observeParents) for (var e = w.container.parents(), a = 0; a < e.length; a++) {
          d(e[a]);
        }
        d(w.container[0], {
          childList: !1
        ...
        if (w.params.loop && w.destroyLoop(), "object" == _typeof(e) && e.length) for (var a = 0; a < e.length; a++) {
        ...
        load: function load() {
          ...
          });else if (w.params.slidesPerView > 1) for (e = w.activeIndex; e < w.activeIndex + w.params.slidesPerView; e++) {
        ...
        setTranslate: function setTranslate(e, a) {
          ...
          var s,
              i,
              n = w.params.control;
          if (w.isArray(n)) for (var o = 0; o < n.length; o++) {
        ...
        setTransition: function setTransition(e, a) {
          ...
          var s,
              i = w.params.control;
          if (w.isArray(i)) for (s = 0; s < i.length; s++) {
      ...
      return w.callPlugins = function (e) {
        ...
        var a;
        if (w.emitterEventListeners[e]) for (a = 0; a < w.emitterEventListeners[e].length; a++) {
  ...
  for (var r = function () {
    var e = function e(_e) {
      ...
      if (_a) if ("string" == typeof _a) {
        ...
        if (o.indexOf("<") >= 0 && o.indexOf(">") >= 0) {
          ...
          for (0 === o.indexOf("<li") && (l = "ul"), 0 === o.indexOf("<tr") && (l = "tbody"), (0 === o.indexOf("<td") || 0 === o.indexOf("<th")) && (l = "tr"), 0 === o.indexOf("<tbody") && (l = "table"), 0 === o.indexOf("<option") && (l = "select"), n = document.createElement(l), n.innerHTML = _a, s = 0; s < n.childNodes.length; s++) {
    ...
    return e.prototype = {
      ...
      on: function on(e, t, r, s) {
        function i(e) {
          var s = e.target;
          if (a(s).is(t)) r.call(s, e);else for (var i = a(s).parents(), n = 0; n < i.length; n++) {
...
},{}],"../../../../Users/FC/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/FC/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/swiper.js"], null)
